...
A entrada favorável é uma imagem realista gerada por IA com régua, placa,
tecido, parafusos, linhas e contornos. O caso B adiciona texturas orgânicas e
elementos com menor contraste.

Comandos principais:

```bash
./build/ucrt64-debug/lab_m1_3.exe \
    images/input/ai_realistic/m1_3/m1_3_a_espacial_bordas.png \
    images/output/prompt_33_4/m1_3/favoravel/mean3 \
    --operation mean3 --border replicate --save-data

./build/ucrt64-debug/lab_m1_3.exe \
    images/input/ai_realistic/m1_3/m1_3_a_espacial_bordas.png \
    images/output/prompt_33_4/m1_3/favoravel/laplacian8 \
    --operation laplacian8 --border replicate --factor 1.0 --save-data

./build/ucrt64-debug/lab_m1_3.exe \
    images/input/ai_realistic/m1_3/m1_3_a_espacial_bordas.png \
    images/output/prompt_33_4/m1_3/favoravel/sobel \
    --operation sobel --border replicate --save-data
```

### Suavização e Laplaciano

<div class="pdi_gallery_grid">
<div class="pdi_gallery_card">
<a class="pdi_gallery_link" href="../images/results/m1_3/favoravel_mean_3x3.png">
<img src="../images/results/m1_3/favoravel_mean_3x3.png" alt="Imagem favorável suavizada com média 3 por 3." loading="lazy">
</a>
<div class="pdi_gallery_caption">Média 3 × 3: reduz variações locais e suaviza texturas finas.</div>
</div>
<div class="pdi_gallery_card">
<a class="pdi_gallery_link" href="../images/results/m1_3/favoravel_laplacian_8_response.png">
<img src="../images/results/m1_3/favoravel_laplacian_8_response.png" alt="Resposta Laplaciana de oito vizinhos." loading="lazy">
</a>
<div class="pdi_gallery_caption">Resposta bruta visualizada em torno do nível intermediário.</div>
</div>
<div class="pdi_gallery_card">
<a class="pdi_gallery_link" href="../images/results/m1_3/favoravel_laplacian_8_enhanced.png">
<img src="../images/results/m1_3/favoravel_laplacian_8_enhanced.png" alt="Imagem realçada pela resposta Laplaciana." loading="lazy">
</a>
<div class="pdi_gallery_caption">Realce com fator 1,0: bordas se tornam mais evidentes sem substituir a imagem.</div>
</div>
</div>
...
<div class="pdi_gallery_grid">
<div class="pdi_gallery_card">
<a class="pdi_gallery_link" href="../images/results/m1_3/favoravel_sobel_gx.png">
<img src="../images/results/m1_3/favoravel_sobel_gx.png" alt="Resposta horizontal Gx do operador Sobel." loading="lazy">
</a>
<div class="pdi_gallery_caption">Gx responde principalmente a transições verticais.</div>
</div>
<div class="pdi_gallery_card">
<a class="pdi_gallery_link" href="../images/results/m1_3/favoravel_sobel_gy.png">
<img src="../images/results/m1_3/favoravel_sobel_gy.png" alt="Resposta vertical Gy do operador Sobel." loading="lazy">
</a>
<div class="pdi_gallery_caption">Gy responde principalmente a transições horizontais.</div>
</div>
<div class="pdi_gallery_card">
<a class="pdi_gallery_link" href="../images/results/m1_3/favoravel_sobel_magnitude_euclidean.png">
<img src="../images/results/m1_3/favoravel_sobel_magnitude_euclidean.png" alt="Magnitude euclidiana do Sobel no caso favorável." loading="lazy">
</a>
<div class="pdi_gallery_caption">Magnitude euclidiana combina Gx e Gy.</div>
</div>
<div class="pdi_gallery_card">
<a class="pdi_gallery_link" href="../images/results/m1_3/desafiador_sobel_magnitude_euclidean.png">
<img src="../images/results/m1_3/desafiador_sobel_magnitude_euclidean.png" alt="Magnitude euclidiana do Sobel no caso desafiador." loading="lazy">
</a>
<div class="pdi_gallery_caption">Caso desafiador: textura e contornos orgânicos geram resposta mais distribuída.</div>
</div>
</div>

Os arquivos YAML de matrizes intermediárias não foram incorporados à
documentação. Consulte as
