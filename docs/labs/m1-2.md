...
O estudo de caso preliminar procura simplificar zonas de iluminação por
conversão ponderada e quantização. Os dois comandos abaixo foram executados com
as entradas realistas geradas por IA A e B:

```bash
./build/ucrt64-debug/lab_m1_2.exe \
    images/input/ai_realistic/m1_2/m1_2_a_dominio_valor.png \
    images/output/prompt_33_4/m1_2/favoravel

./build/ucrt64-debug/lab_m1_2.exe \
    images/input/ai_realistic/m1_2/m1_2_b_dominio_valor.png \
    images/output/prompt_33_4/m1_2/desafiador
```

<div class="pdi_gallery_grid">
<div class="pdi_gallery_card">
<a class="pdi_gallery_link" href="../images/results/m1_2/favoravel_grayscale_weighted.png">
<img src="../images/results/m1_2/favoravel_grayscale_weighted.png" alt="Caso favorável do M1.2 convertido para níveis de cinza." loading="lazy">
</a>
<div class="pdi_gallery_caption">Entrada favorável: iluminação localizada, objetos e texturas variadas.</div>
</div>
<div class="pdi_gallery_card">
<a class="pdi_gallery_link" href="../images/results/m1_2/favoravel_quantized_004_levels.png">
<img src="../images/results/m1_2/favoravel_quantized_004_levels.png" alt="Caso favorável do M1.2 quantizado para quatro níveis." loading="lazy">
</a>
<div class="pdi_gallery_caption">Saída representativa: quatro zonas tonais simplificam a cena.</div>
</div>
<div class="pdi_gallery_card">
<a class="pdi_gallery_link" href="../images/results/m1_2/desafiador_grayscale_weighted.png">
<img src="../images/results/m1_2/desafiador_grayscale_weighted.png" alt="Caso desafiador do M1.2 convertido para níveis de cinza." loading="lazy">
</a>
<div class="pdi_gallery_caption">Caso desafiador: transição luminosa ampla e objetos claros próximos.</div>
</div>
<div class="pdi_gallery_card">
<a class="pdi_gallery_link" href="../images/results/m1_2/desafiador_quantized_004_levels.png">
<img src="../images/results/m1_2/desafiador_quantized_004_levels.png" alt="Caso desafiador do M1.2 quantizado para quatro níveis." loading="lazy">
</a>
<div class="pdi_gallery_caption">A quantização separa zonas, mas perde detalhes do papel e das sombras.</div>
</div>
</div>

**Critério de sucesso:** o relatório exigia ao menos três níveis distintos na
saída de quatro níveis. As duas execuções produziram exatamente quatro níveis e
registraram `preliminary_success=true`.

**Limitação:** o critério confirma diversidade radiométrica, mas não mede se as
zonas correspondem semanticamente aos objetos. Consulte as
